...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1769857240);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1769857240);
user_pref("app.update.lastUpdateTime.region-update-timer", 1769857240);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1769857240);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1769857271);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1769857240);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{14a4c091-8764-48e4-a9cf-931e6d76f922}");
...
user_pref("browser.startup.lastColdStartupCheck", 1769860115);
...
user_pref("captchadetection.lastSubmission", 1769857);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECEH6rVcE4LaPBAjE0JPYLGm8mQ==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"361803ba-68d8-4791-8e92-544431107e96\",\"pictureinpicture@mozilla.org\":\"b541d59c-a455-48f3-b368-631cb7a5bd29\",\"screenshots@mozilla.org\":\"54eb422c-1016-4518-8556-9ae986fa4909\",\"webcompat@mozilla.org\":\"6b40c105-b0d4-47de-9ad6-90faf17182b9\",\"firefox-compact-dark@mozilla.org\":\"921e63e0-4e5d-4d7f-9a10-15e2375b54ea\",\"addons-search-detection@mozilla.com\":\"adf56624-4fe9-443c-a919-0a5ce20a04d0\"}");
...
user_pref("media.gmp-manager.lastCheck", 1769857240);
user_pref("media.gmp-manager.lastEmptyCheck", 1769857240);
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECJhS5DKyoIvDBAjSXf1oxumZQA==");
user_pref("toolkit.startup.last_success", 1769860109);
