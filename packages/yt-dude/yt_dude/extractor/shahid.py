...
class ShahidBaseIE(AWSIE):
    ...
    _AWS_API_KEY = os.getenv('YT_DUDE_SHAHID_API_KEY')
    _AWS_ACCESS_KEY = os.getenv('YT_DUDE_SHAHID_AWS_ACCESS_KEY')
    _AWS_SECRET_KEY = os.getenv('YT_DUDE_SHAHID_AWS_SECRET_KEY')
    ...
    def _call_api(self, path, video_id, request=None):
        ...
        if not self._AWS_ACCESS_KEY or not self._AWS_SECRET_KEY:
            raise ExtractorError(
                'Shahid extractor credentials are not configured. '
                'Set YT_DUDE_SHAHID_AWS_ACCESS_KEY and YT_DUDE_SHAHID_AWS_SECRET_KEY.',
                expected=True)
        try:
